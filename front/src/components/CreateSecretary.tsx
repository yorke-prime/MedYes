                    ...
                    <C.ContainerX>
                        <form onSubmit={onSubmit}>
                            ...
                            <div>
                                ...
                                <input {...register("admission", { required: true, valueAsDate: true, })} id="admission" name="admission" type="date" />
                                {
                                    errors.admission && <div className="error">Digite um nome email</div>
                                }
                            </div>
                            <div>
